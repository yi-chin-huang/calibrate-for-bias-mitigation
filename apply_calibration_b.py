...
gender_table['gender_calibrate_2'] = gender_table['prob_one_neutral'] - gender_table['prob_two']
gender_table['gender_calibrate_3'] = gender_table['prob_one_neutral'] - gender_table['prob_three']
gender_table['gender_calibrate_4'] = gender_table['prob_one_neutral'] - gender_table['prob_four']
gender_table['gender_calibrate_5'] = gender_table['prob_one_neutral'] - gender_table['prob_five']
...
race_table['race_calibrate_2'] = race_table['prob_one_neutral'] / race_table['prob_two']
race_table['race_calibrate_3'] = race_table['prob_one_neutral'] / race_table['prob_three']
race_table['race_calibrate_4'] = race_table['prob_one_neutral'] / race_table['prob_four']
race_table['race_calibrate_5'] = race_table['prob_one_neutral'] / race_table['prob_five']
