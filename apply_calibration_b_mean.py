...
df['1'] = df['predicted_prob_one_exp'] + ((df['gender_calibrate_1'] + df['race_calibrate_1']) / 2)
df['2'] = df['predicted_prob_two_exp'] + ((df['gender_calibrate_2'] + df['race_calibrate_2']) / 2)
df['3'] = df['predicted_prob_three_exp'] + ((df['gender_calibrate_3'] + df['race_calibrate_3']) / 2)
df['4'] = df['predicted_prob_four_exp'] + ((df['gender_calibrate_4'] + df['race_calibrate_4']) / 2)
df['5'] = df['predicted_prob_five_exp'] + ((df['gender_calibrate_5'] + df['race_calibrate_5']) / 2)
df.loc[df['race_calibrate_1'].isnull(), '1'] = df['predicted_prob_one_exp'] + df['gender_calibrate_1']
df.loc[df['race_calibrate_2'].isnull(), '2'] = df['predicted_prob_two_exp'] + df['gender_calibrate_2']
df.loc[df['race_calibrate_3'].isnull(), '3'] = df['predicted_prob_three_exp'] + df['gender_calibrate_3']
df.loc[df['race_calibrate_4'].isnull(), '4'] = df['predicted_prob_four_exp'] + df['gender_calibrate_4']
df.loc[df['race_calibrate_5'].isnull(), '5'] = df['predicted_prob_five_exp'] + df['gender_calibrate_5']
...
df.to_csv("calibrate/calibrated_b_mean_results.csv")
